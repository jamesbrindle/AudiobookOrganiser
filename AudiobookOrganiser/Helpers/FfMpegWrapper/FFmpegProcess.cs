...
namespace AudiobookOrganiser.Helpers.FfMpegWrapper
{
    internal sealed class FfMpegProcess
    {
        ...
        internal event Action<ConversionProgressEventArgs> Progress;
        internal event Action<ConversionCompleteEventArgs> Completed;
        internal event Action<ConversionErrorEventArgs> Error;
        internal event Action<ConversionDataEventArgs> Data;
